    ...
    <html lang="en">
      <body className={`${inter.className}
       bg-gray-50 text-gray-950 relative h-[5000px] pt-28 sm:pt-36`}>
        ...
        rounded-full blur-[10rem] w-[60rem] sm:w-[68.75rem]"></div>
        <div className="bg-[#dbd7fb] absolute top-[-1rem] -z-10 left-[-35rem] h-[50rem] 
        rounded-full blur-[10rem] w-[60rem] sm:w-[68.75rem] md:left-[-33rem] lg:left-[-28rem] xl:left-[-15rem] 2xl:left-[-5rem]"></div>
        <Navbar />
        {children}
      </body>
    </html>
